...
const data = JSON.parse(fs.readFileSync('wind/tmp.json'));
...
png.pack().pipe(fs.createWriteStream('wind/' + name + '.png'));

fs.writeFileSync('wind/' + name + '.json', JSON.stringify({
    source: 'http://nomads.ncep.noaa.gov',
    date: formatDate(dataDate + '', dataTime),
    isBlueChannelEnabled: false,
    width: width,
    height: height,
    uMin: uMinimum,
    uMax: uMaximum,
